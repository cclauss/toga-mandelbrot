...
IMG_SIZE=32 3520 x 1280 elapsed time: 0:00:26.864843
"""

FILENAME = "cc_mandelbrot.png"
IMG_SIZE = 32  # 1 thru 16 are resonable
...
def make_colors():
    return (
        [(i * 4 + 128, i * 4, 0) for i in range(64)]
...
def z_main():
    print("Hello from toga-mandelbrot!")
